 ...
 * Creates the html form needed for submitting the 'Create new account'
 * request to the admin controller.
 *
 * @category Nosto
 * @package  Nosto_Tagging
 * @author   Nosto Solutions Ltd <magento@nosto.com>
...
class Nosto_Tagging_Block_Adminhtml_Form_Account_Create extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->addField(
            'nosto_create_account_email', 'text', array(
                'label' => $this->__('Email'),
        ...
        $form->addField(
            'nosto_terms_and_conditions', 'note', array(
        ...
        $form->addField(
            'nosto_create_account_submit', 'submit', array(
                'class' => 'form-button',
