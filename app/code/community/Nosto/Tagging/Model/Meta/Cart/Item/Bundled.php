...
/**
 * Meta data class which holds information about a bundled item included in an cart.
 *
 * @category Nosto
 * @package  Nosto_Tagging
 * @author   Nosto Solutions Ltd <magento@nosto.com>
 */
class Nosto_Tagging_Model_Meta_Cart_Item_Bundled extends Nosto_Tagging_Model_Meta_Cart_Item
{
